...
// Time when SCARA running
#define high 1.0f
#define med 2.0f
#define low 4.0f
#define time_base 2.0f
#define home_time 1.5f
...
void pulse_calc(SERVO_ENUM servo,float t,float tf); // --> tinh gia tri xung cho 1 truc

void pulse_total(uint16_t k,float tf); // --> tinh gia tri xung cho tat ca cac truc
