...
plot(t,Xt,'r',t,Xtd,'g',t,Xtdd,'b', t, Xt_cubic,':r')
grid on
legend('X', 'Xdot', 'Xddot','X cubic')

figure
plot(t,theta1,'r', t,theta2,'b', t,theta1_cubic,':r', t,theta2_cubic,':b')
grid on
legend('\theta1', '\theta2','\theta1 cubic', '\theta2 cubic')
